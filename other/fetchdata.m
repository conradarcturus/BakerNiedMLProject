function [dist,distold,lat,lon,timeglobal,dayofweek,days,time,tripid,dev] = fetchdata(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [DIST1,DISTOLD,LAT,LON,TIMEGLOBAL,DAYOFWEEK,DAYS,TIME,TRIPID] =
...
% Example:
%   [dist1,distold,lat,lon,timeglobal,dayofweek,days,time,tripid] =
%   importfile('intercitytransit_route13_allfeats.txt',1, 25886);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/11/25 17:08:14
...
lat = dataArray{:, 3};
lon = dataArray{:, 4};
timeglobal = dataArray{:, 5};
dayofweek = dataArray{:, 6};
days = dataArray{:, 7};
time = dataArray{:, 8};
tripid = dataArray{:, 9};
dev = dataArray{:, 10};
